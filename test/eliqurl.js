    ...
    describe('#from', function () {
        it('reads config.eliqUrl and accessToken', function () {
            ...
            expect(eliqurl.from(startdate, '6min')).to
                .equal('https://eliq.url/?accesstoken=xxxxx&startdate=2012-11-04T17:00:00.000Z&intervaltype=6min');
        });
    });
    describe('#fromTo', function () {
        it('reads config.eliqUrl and accessToken', function () {
            ...
            expect(eliqurl.fromTo(startdate, enddate, 'day')).to
                .equal('https://eliq.url/?accesstoken=xxxxx&startdate=2012-11-03T17:00:00.000Z&enddate=2012-11-04T17:00:00.000Z&intervaltype=day');
        });
    });
});